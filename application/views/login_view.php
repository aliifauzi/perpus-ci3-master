...
<body class="hold-transition login-page" style=": hidden;background:url(
	'<?php echo base_url('assets_style/image/login3.jpg');?>') no-repeat; background-size:cover  ;">
<div class="login-box">
  <div class="login-logo">
    <a href="index.php" style="color: White;"><b>PERPUSTAKAAN KITA</b></a>
  </div>
