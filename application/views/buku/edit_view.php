                    ...
                    <form action="<?php echo base_url('data/prosesbuku');?>" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label>ISBN</label>
                                    <input type="text" class="form-control" value="<?= $buku->isbn;?>" name="isbn" required="required" placeholder="123-222-1122-11-2" autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <label>Judul Buku</label>
                                    <input type="text" class="form-control" value="<?= $buku->title;?>" name="title" required="required" placeholder="Algoritma & Pemrograman" autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <label>Nama Pengarang</label>
                                    <input type="text" class="form-control" value="<?= $buku->pengarang;?>" name="pengarang" required="required" placeholder="Nama Pengarang" autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <label>Penerbit</label>
                                    <input type="text" class="form-control" value="<?= $buku->penerbit;?>" name="penerbit" required="required" placeholder="Nama Penerbit" autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <label>Tahun Buku</label>
                                    <input type="number" class="form-control" value="<?= $buku->thn_buku;?>" name="thn" required="required" placeholder="2001" autocomplete="off">
                                </div>
                            ...
                            <div class="col-sm-6">
								...
								<div class="form-group">
                                    ...
                                    <input type="number" class="form-control" value="<?= $buku->jml;?>" required="required" name="jml" placeholder="12">
								</div>
                                <div class="form-group">
