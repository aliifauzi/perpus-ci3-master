							...
							<div class="col-sm-5">
								<table class="table table-striped">
									...
									<tr>
										...
										<td>:</td>
										<td>
											<input type="date" value="<?= date('Y-m-d');?>" name="tgl" class="form-control" required="required">
										</td>
									</tr>
									<tr>
										<td>ID Anggota</td>
										...
										<td>
											<div class="input-group">
												<input type="text" class="form-control" required="required" autocomplete="off" name="anggota_id" id="search-box" placeholder="Contoh ID Anggota : AG001" type="text" value="">
									...
									<tr>
										...
										<td>:</td>
										<td>
											<input type="number" required="required" placeholder="2 Hari (2)" name="lama" class="form-control">
										</td>
									</tr>
								</table>
							</div>
							<div class="col-sm-7">
								<table class="table table-striped">
									...
									<tr>
										...
										<td>
											<div class="input-group">
												<input type="text" class="form-control" autocomplete="off" name="buku_id" id="buku-search" type="text" value="" required="required">
												<span class="input-group-btn">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $isi['tgl_masuk'];?></td>
                            <td style="width:17%">
                                <button class="btn btn-primary Select_File2" data-id="<?= $isi['buku_id'];?>">
...
<script>
    $(document).ready(function(){
        $(".fileSelection1 .Select_File2").click(function (e) {
            var selectedBukuId = $(this).data("id");
            document.getElementsByName('buku_id')[0].value = selectedBukuId;
            $('#TableBuku').modal('hide');
            
            // Optional: Update tampilan data buku yang dipilih
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('transaksi/buku');?>",
                data: 'kode_buku=' + selectedBukuId,
                beforeSend: function(){
                    $("#result_buku").html("");
