					...
					<div class="box box-primary">
						...
						<div class="box-body">
							...
							<form method="post" action="<?= base_url('data/rakproses');?>">
								...
								<input type="text" name="rak"  value="<?=$rak->nama_rak;?>" id="rak" class="form-control" required="required" placeholder="Rak Pemrograman"  autocomplete="off">
							...
							<form method="post" action="<?= base_url('data/rakproses');?>">
								<div class="form-group">
								<label for="">Nama Rak / Lokasi</label>
								<input type="text" name="rak" id="rak" class="form-control" required="required" placeholder="Rak Pemrograman"  autocomplete="off">
